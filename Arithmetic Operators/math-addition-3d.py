...
def generate_addition_problems(n=600):
    questions = []
    for i in range(n):
...
questions_with_answers = generate_addition_problems()

# Create PDF document with answers
doc = SimpleDocTemplate("addition_worksheet_with_answers.pdf", pagesize=landscape(letter))
...
doc = SimpleDocTemplate("addition_worksheet_without_answers.pdf", pagesize=landscape(letter))
